...
<head>
    ...
    <meta name="description" content="HUB MÉDIA - COVID-19, est une platefrome de centralisation des informations autour du COVID-19 permettant de suivre l'évolution du coronavirus au Gabon.">
    ...
    <meta name="og:description" content="HUB MÉDIA - COVID-19, est une platefrome de centralisation des informations autour du COVID-19 permettant de suivre l'évolution du coronavirus au Gabon.">
...
<body>
    ...
    <section class="articles">
        <?php foreach ($data['articles'] as $key => $article) : ?>
            <?php if (($key + 1) % 10 == 0) : ?>
                <div class="article article-fluid" id="<?= $article['id'] ?>">
                    <div>
                        <p><?= $article['titre'] ?></p>
                    </div>
