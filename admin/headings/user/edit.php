<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12 col-lg-4">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="<?= route('user-home') ?>"><?= heading('title') ?></a>
            </li>
                ...
                <div class="ibox-content">
                    <form method="post" action="<?= route('save'); ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input type="email" name="email" value="<?= $data['email']; ?>" placeholder="Adresse e-mail" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control m-b" name="profile">
                                    <option value="1" <?= ($data['profile'] == 1) ? 'selected' : ''; ?>>Standard</option>
                                    <option value="2" <?= ($data['profile'] == 2) ? 'selected' : ''; ?>>Rédacteur</option>
                                    <option value="3" <?= ($data['profile'] == 3) ? 'selected' : ''; ?>>Chef de rédaction</option>
                                    <option value="4" <?= ($data['profile'] == 4) ? 'selected' : ''; ?>>Administrateur</option>
                                    <option value="99" <?= ($data['profile'] == 99) ? 'selected' : ''; ?>>Super administrateur</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
