<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12 col-lg-4">
        <h2><?= ucfirst(heading('plural')) ?> du Gabon</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href=".">Accueil</a>
            </li>
            <li class="breadcrumb-item active">
                <strong><?= heading('title') ?> du Gabon</strong>
            </li>
        </ol>
    </div>
    <div class="col-sm-8">
        <?php if (has_right(heading('add'))) : ?>
            <div class="title-action">
                <a href="<?= route('add') ?>" class="btn btn-primary d-print-none"><i class="fa fa-plus"></i> Nouvelle donnée</a>
            </div>
        <?php endif; ?>
    </div>
</div>
    ...
    <?php else : ?>
        <div class="middle-box text-center animated bounceIn">
            ...
            <div class="error-desc">
                ...
                <a href="<?= route('add') ?>" class="btn btn-primary m-t"><i class="fa fa-plus"></i> Ajouter <?= heading('male') ? 'un nouveau' : 'une nouvelle' ?> <?= heading('singular') ?></a>
            </div>
        </div>
    <?php endif; ?>
</div>